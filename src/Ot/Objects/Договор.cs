...
namespace IIS.Ot
{
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        [PropertyStorage(new string[] {
                "РукОтдЛог"})]
        [NotNull()]
        public virtual IIS.Ot.РукОтдЛог РукОтдЛог
        {
            get
            {
                ...
                IIS.Ot.РукОтдЛог result = this.fРукОтдЛог;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.Ot.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.Ot.Договор));
                }
            }
        }
    }
