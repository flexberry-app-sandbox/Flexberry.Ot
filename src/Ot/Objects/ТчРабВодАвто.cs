    ...
    public class ТчРабВодАвто : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТчРабВодАвтоE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТчРабВодАвтоE", typeof(IIS.Ot.ТчРабВодАвто));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТчРабВодАвтоL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТчРабВодАвтоL", typeof(IIS.Ot.ТчРабВодАвто));
                }
            }
        }
    }
